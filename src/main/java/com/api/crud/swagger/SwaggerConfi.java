...
public class SwaggerConfi {
	...
	private ApiInfo apiendpointsinfo() {
		...
		.description("API information about customer details").contact(new Contact("Triotend Solution", "www.trio.com", "sarathrasa01@gmail.com"))
		.license("TTS-7.3").version("7.3.5").build();
